...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/homework5-hw5_grup3/resources/css/style.css">
</head>
...
<div class = "container-fluid m-0 p-0">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-primary mb-5"  >
        <a class="navbar-brand" href="http://localhost/homework5-hw5_grup3/index.php" style="color: white; font-weight:bold">Homework5-hw5_grup3</a>
